...
(function ($, window, document, undefined) {
  ...
  function dragHandler(event) {
    ...
    dragging.pointer = dragging.touch
      ? event.originalEvent[dragging.released ? "changedTouches" : "touches"][0]
      : event;
      ...
      case "scroll":
        ...
        if (transform) {
          $handle[0].style[transform] =
            gpuAcceleration + "translateX" + "(" + current + "px)";
        } else {
    ...
    if (index != hPos.index) {
      hPos.index = index;
      Instance.$element.trigger("to.owl.carousel", [
        index,
        animationSpeed,
        true,
      ]);
  ...
  function dragEnd() {
    ...
    $(document).off(
      dragging.touch ? dragTouchEvents : dragMouseEvents,
      dragHandler
    );
...
(function ($, window, document, undefined) {
  ...
  $(document).ready(function () {
    ...
    if ($charts.length) {
      ...
      document
        .getElementById("randomizeData-bar")
        .addEventListener("click", function () {
      ...
      document
        .getElementById("removeDataset-bar")
        .addEventListener("click", function () {
          barChartData.datasets.pop();
          window.myBar.update();
        });
      document
        .getElementById("removeData-bar")
        .addEventListener("click", function () {
      ...
      document
        .getElementById("randomizeData-pie")
        .addEventListener("click", function () {
      ...
      document
        .getElementById("removeDataset-pie")
        .addEventListener("click", function () {
      ...
      document
        .getElementById("randomizeData-doughnut")
        .addEventListener("click", function () {
      ...
      document
        .getElementById("addDataset-doughnut")
        .addEventListener("click", function () {
          var newDataset = {
            backgroundColor: [],
            data: [],
          ...
          for (
            var index = 0;
            index < config_doughnut.data.labels.length;
            ++index
          ) {
            newDataset.data.push(randomScalingFactor());
            var colorName = colorNames[index % colorNames.length];
      ...
      document
        .getElementById("addData-doughnut")
        .addEventListener("click", function () {
          if (config_doughnut.data.datasets.length > 0) {
            config_doughnut.data.labels.push(
              "data #" + config_doughnut.data.labels.length
            );
            var colorName =
              colorNames[
                config_doughnut.data.datasets[0].data.length % colorNames.length
              ];
            var newColor = window.chartColors[colorName];
            config_doughnut.data.datasets.forEach(function (dataset) {
              dataset.data.push(randomScalingFactor());
      ...
      document
        .getElementById("removeDataset-doughnut")
        .addEventListener("click", function () {
          config_doughnut.data.datasets.splice(0, 1);
          window.myDoughnut.update();
        });
      document
        .getElementById("removeData-doughnut")
        .addEventListener("click", function () {
      ...
      document
        .getElementById("changeCircleSize")
        .addEventListener("click", function () {
  ...
  $(document).ready(function () {
    ...
    if ($site_container.hasClass("footer-reveal")) {
      ...
      if ($footer_top.length) {
        $footer_top.css(
          "margin-bottom",
          $footer.height() + $footer_bottom.height() - 1
        );
...
(function ($, window, document, undefined) {
  ...
  $(document).ready(function () {
    ...
    $(document).on("click", function (event) {
      if (
        !$(event.target).closest(".floating_buttons").length &&
        $(".floating_buttons").hasClass("is-active")
      ) {
    ...
    $(document).on("click", function (event) {
      if (
        !$(event.target).closest(".quickview").length &&
        !$(event.target).closest(".show-quickview").length &&
        $(".quickview").hasClass("is-active") &&
        !$(event.target).closest(".floating_buttons").length
      ) {
...
(function ($, window, document, undefined) {
  ...
  $(document).ready(function () {
    ...
    var pagerClass =
      "pagination is-centered isotope-pager pagination-list is-rounded";
    ...
    function setPagination() {
      ...
      var CreatePagers = (function () {
        ...
        for (var i = 0; i < currentNumberPages; i++) {
          var $pager = $(
            '<a href="javascript:void(0);" class="pager pagination-link" ' +
              pageAtribute +
              '="' +
              (i + 1) +
              '"></a>'
      ...
      zoom: {
        ...
        opener: function (openerElement) {
          return openerElement.is("img")
            ? openerElement
            : openerElement.closest("figure").find("img");
        },
      },
    };
...
(function ($, window, document, undefined) {
  ...
  $(document).ready(function () {
    ...
    var $site_container = $("body");
    var $site_container_rtl = $("body.rtl");
    var $one_page_nav_link = $header.find(
      '.main-navigation ul li a[href*="#"]:not([href="#"])'
    );
    var $global_hash_link = $site_container.find(
      'a[href*="#"]:not([href="#"])'
    );
              ...
              },
              {
                ...
                progress: function () {
                  ...
                  if (header_offset_height - $header.height() > 0) {
                    $(this).css(
                      "margin-top",
                      header_offset_height - $header.height()
                    );
                  } else {
                    $(this).css("margin-top", "");
                  }
...
(function ($, window, document, undefined) {
  ...
  $(document).ready(function () {
    ...
    var header_center_overlay_padding = parseInt(
    ...
    if (
      !$site_container.hasClass("header-transparent") &&
      !$site_container.hasClass(" header-transparent-overlay") &&
      !$site_container.hasClass("header-transparent-border")
    ) {
    ...
    $(window).scroll(function () {
      ...
      if (
        $site_container.hasClass("header-sticky") &&
        !$site_container.hasClass("header-side-navigation")
      ) {
        ...
        if ($site_container.hasClass("show-on-scroll")) {
          ...
          if (windowTop !== 0) {
            ...
            if (windowTop > $header.height()) {
              ...
              if ($site_container.hasClass("header-center-overlay")) {
                $header
                  ...
                  .css(
                    "top",
                    -($header.height() + header_center_overlay_padding)
                  );
              } else {
            ...
            if (
              $site_container.hasClass("header-center-overlay") ||
              $site_container.hasClass("header-transparent") ||
              $site_container.hasClass("header-transparent-overlay")
            ) {
              $header.css("top", 0);
        ...
        if ($site_container.hasClass("hide-on-scroll")) {
          ...
          if (currentScrollPos !== 0) {
            ...
            if (prevScrollpos > currentScrollPos) {
              ...
              if (
                $site_container.hasClass("header-menu-background-primary") ||
                $site_container.hasClass("header-menu-background-dark")
              ) {
                $header.addClass("hide-on-scroll");
              }
            } else {
            ...
            if (
              $site_container.hasClass("header-topbar") &&
              $site_container.hasClass("header-transparent")
            ) {
...
(function ($, window, document, undefined) {
  ...
  $(document).ready(function () {
    ...
    var $header_hamburger_menu_level = $(
      ".header-hamburger-menu header .level:last-child"
    );
    var active_hamburger_menu = $site_container.hasClass(
    ...
    var active_header_side_navigation = $site_container.hasClass(
      "header-side-navigation"
    );
    var active_header_side_navigation_mini =
      $site_container.hasClass("side-mini");
    var active_header_slide_up = $header_hamburger_menu.hasClass("slide-up");
    var active_header_slide_down =
      $header_hamburger_menu.hasClass("slide-down");
    var $header_main = $("#header-wrap header");
    var $header_container = $("#header-wrap header .site-header-inner");
    var active_header_full_width =
      $header_container.hasClass("header-fullwidth");
    var $window = $(window);
    ...
    function check_width() {
      ...
      if (
        !active_hamburger_menu &&
        !active_header_logo_top &&
        !active_header_menu_top &&
        !active_header_side_navigation
      ) {
        if (!$header_container.find(".level.top").length) {
          if ($site_container.hasClass("header-logo-right")) {
            $header_container.prepend(
      ...
      if (active_header_logo_top) {
        if (!$header_container.find(".level.top .level-right").length) {
          $header_container
            .find(".level.top")
            .append(
              '<div class="level-right" style="display: none;"><div class="hamburger-menu"><span class="hamburger-menu-icon"></span></div></div>'
            );
        } else {
          if (
            $site_container.hasClass("header-logo-with-icons") &&
            $header_container.find(".level.top .level-right").length < 2
          ) {
            $header_container
              .find(".level.top")
              .append(
      ...
      if (active_header_menu_top) {
        if (
          !$header_container.find(".level").last().find(".level-right.num-2")
            .length
        ) {
          $header_container
            .find(".level")
            .last()
            .append(
              '<div class="level-right num-2" style="display: none;"><div class="hamburger-menu"><span class="hamburger-menu-icon"></span></div></div>'
            );
        }
      ...
      if (
        active_header_side_navigation &&
        !active_header_side_navigation_mini
      ) {
        if (!$header_container.find(".level.top").length) {
      ...
      if (window_size < 1088) {
        ...
        if ($site_container.hasClass("footer-widgets")) {
          $site_container
            .find("#footer-wrap .site-footer-inner .columns .column")
            .each(function () {
        ...
        if (!active_hamburger_menu && !active_header_side_navigation) {
          if ($site_container.hasClass("header-logo-right")) {
            $site_container.addClass(
              "header-hamburger-menu slide-left slide-overlay"
            );
          } else {
            $site_container.addClass(
              "header-hamburger-menu slide-right slide-overlay"
            );
          }
            ...
            if (active_header_logo_top) {
              ...
              if (
                !$header_container
                  .find(".level")
                  .first()
                  .find(".level-left .site-logo ").length
              ) {
              ...
              $header_container
                ...
                .css("margin", 0);
              if (
                $header_container.find(".level").first().find(".level-left")
                  .length === 2
              ) {
                $header_container
                  .find(".level")
          ...
          if (
            $site_container.hasClass("header-logo-center") ||
            active_header_logo_top
          ) {
            $header_container.find(".logo-text").hide();
          }
          ...
          $header_container
            ...
            .css("display", "flex");
          $header_container
            .find(".nav-menu-dropdown")
            .css("visibility", "visible")
            .show();

          $hamburger_menu = $(".hamburger-menu");
          $header_hamburger_menu = $(".header-hamburger-menu");
          $header_hamburger_menu_level = $(
            ".header-hamburger-menu header .level:last-child"
          );
          ...
          if ($site_container.hasClass("header-logo-right")) {
            ...
            $site_container.hasClass("header-logo-center-menu-center")
          ) {
            ...
            if (active_header_logo_top) {
              if ($site_container.hasClass("header-logo-with-icons")) {
                ...
                if (
                  $header_hamburger_menu_level.find(".level-left").length > 1
                ) {
                  $header_hamburger_menu_level
                    .find(".level-left")
                    .first()
        ...
        if (active_header_slide_up || active_header_slide_down) {
          ...
          if ($site_container.hasClass("icon-left")) {
            $site_container.addClass(
              "slide-left slide-overlay slide-up-down-left"
            );
          } else {
        ...
        if (
          $header_hamburger_menu_level.css("margin-right") === "0px" &&
          $header_hamburger_menu_level.css("margin-left") === "0px"
        ) {
          if (
            $header_hamburger_menu.hasClass("slide-right") ||
            $header_hamburger_menu.hasClass("slide-left")
          ) {
        ...
        if (active_header_slide_up || active_header_slide_down) {
          ...
          if ($site_container.hasClass("icon-left")) {
            ...
            $site_container.removeClass(
              "slide-right slide-overlay slide-up-down"
            );
          }
    ...
    if ($nav_menu.length) {
      ...
      $nav_menu.find("> ul > li").each(function () {
        if (
          ...
          !$("body").hasClass("overlay-full-width") &&
          !$("body").hasClass("slide-overlay") &&
          !$("body").hasClass("header-side-navigation") &&
          !$("body").hasClass("header-background-primary") &&
          !$("body").hasClass("header-background-dark") &&
          !$("body").hasClass("slide-push")
        ) {
          var _this = $(this);
          ...
          if ($("body").hasClass("header-side-navigation")) {
            ...
            if ($(this).hasClass("niche-templates")) {
              $(this)
                ...
                .css(
                  "margin-left",
                  -($(this).offset().left - main_container_offset)
                )
                .css("margin-top", 0);
            } else {
              $(this)
    ...
    if (
      $site_container.hasClass("header-logo-center") ||
      $site_container.hasClass("header-logo-left") ||
      $site_container.hasClass("header-logo-right") ||
      $site_container.hasClass("header-menu-with-buttons") ||
      $site_container.hasClass("header-menu-with-icons") ||
      $site_container.hasClass("slide-up") ||
      $site_container.hasClass("slide-down")
    ) {
      if (
        $header_container.hasClass("header-fullwidth") &&
        !$site_container.hasClass("menu-center")
      ) {
        $nav_menu.find("> ul > li").each(function () {
          if ($(this).hasClass("mega-menu")) {
            $(this).removeClass("mega-menu");
    ...
    function check_dropdown_menu() {
      ...
      if (window_size < 1088) {
        ...
        if (!$nav_menu.find("> ul > li > span").length) {
          $nav_menu
            .find("> ul > li:has( > ul)")
            .prepend('<span class="main-parent"></span>');
        }
                ...
                .hover(
                  function () {
                    ...
                    if ($(this).children("ul").length) {
                      ...
                      var is_menu_ul_visible =
                        menu_ul_left + menu_ul_width <=
                        site_container_width + site_container_left;
    ...
    if ($nav_menu_icons_dropdown.length) {
      ...
      if ($nav_menu_icons_dropdown.find("ul").length) {
        ...
        // show and hide dropdown menu on click
        $nav_menu_icons_dropdown.find("> li").on(
          "click",
          ...
          function (e) {
            ...
            if (
              remove_product_class !== "product-remove" &&
              !$(".dropdown-search-form input").is(":focus") &&
              !$(this).hasClass("search-style-2") &&
              !$(this).find(".dropdown-user-account").is(":visible")
            ) {
              if ($(this).children("ul").is(":visible")) {
                $nav_menu_icons_dropdown.find("ul").hide();
                $nav_menu_icons_dropdown.find("ul").fadeOut("fast");
    ...
    if (
      ...
      $(".rev_slider_wrapper").css(
        "max-width",
        $("body").width() - header_side_width + "px"
      );
          ...
          if (!$(this).hasClass("top")) {
            if (
              !$(event.target).closest(
                ".header-side-navigation .site-header .level"
              ).length
            ) {
              if ($(this).is(":visible")) {
    ...
    if ($hamburger_menu.length) {
      ...
      $(document).on("click", function (event) {
        if (
          !$(event.target).closest("header .level:last-child").length &&
      ...
      $hamburger_menu.on("click", function (e) {
        ...
        if (
          $header_hamburger_menu.hasClass("slide-down") ||
          $header_hamburger_menu.hasClass("slide-up")
        ) {
  ...
  $(document).ready(function () {
    ...
    if ($notify_alert.length) {
      $notify_alert.find(".button").each(function () {
        $(this).on("click", function () {
          if (
            $(this).is("[data-options]") &&
            !$.isEmptyObject($.parseJSON($(this).attr("data-options")))
          ) {
            new Noty(
              $.extend(
                {
    ...
    if ($progress_bar.length) {
      $progress_bar.each(function () {
        ...
        if ($(this).hasClass("circle")) {
          ...
          active_bar = new ProgressBar.Circle(
          ...
          active_bar = new ProgressBar.Line(
            "." + $(this).attr("class").replace(/\s+/g, "."),
            final_options
          );
        }
...
(function ($, window, document, undefined) {
  ...
  $(document).ready(function () {
    ...
    $(".stars-fontawesome-o .current-rating").find("span").html(currentRating);

    $(".stars-fontawesome-o .clear-rating").on("click", function (event) {
      event.preventDefault();

      $("#barrating-fontawesome-o").barrating("clear");
    });
    ...
    $("#barrating-fontawesome-o").barrating({
      ...
      onSelect: function (value, text) {
        if (!value) {
          ...
          $(".stars-fontawesome-o .current-rating").addClass("hidden");
      ...
      $toggle_buttons_class.each(function () {
        ...
        $this
          ...
          .each(function (index) {
            $(this).on("click", function () {
              if (
                !$(this).hasClass("toggle-open-all") &&
                !$(this).hasClass("toggle-close-all")
              ) {
                $this
